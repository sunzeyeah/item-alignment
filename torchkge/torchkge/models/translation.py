...
from ..utils import init_embedding, init_linear_projection

from tqdm.autonotebook import tqdm


class PKGMModel(TranslationModel):
    ...
    * Antoine Bordes, Nicolas Usunier, Alberto Garcia-Duran, Jason Weston, and
    ...
    def __init__(self, emb_dim, n_entities, n_relations, dissimilarity_type='L2'):
        ...
        self.proj_mat = init_linear_projection(self.emb_dim, self.emb_dim, bias=False)
    ...
    def scoring_function(self, h_idx, t_idx, r_idx):
        ...
        projected_h = self.proj_mat(h)
        r = self.rel_emb(r_idx)

        return - self.dissimilarity(h + r, t) - self.dissimilarity(projected_h, r)
